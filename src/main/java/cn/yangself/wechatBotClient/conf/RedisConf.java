package cn.yangself.wechatBotClient.conf;


import cn.yangself.wechatBotClient.conf.cache.IGlobalCache;
import cn.yangself.wechatBotClient.conf.cache.impl.AppRedisIGlobalCache;
...
public class RedisConf extends CachingConfigurerSupport {
    ...
    IGlobalCache cache(RedisTemplate redisTemplate) {
        return new AppRedisIGlobalCache(redisTemplate);
    }
